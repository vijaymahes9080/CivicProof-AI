"""CivicProof AI - MCP Tool Implementations & Business Logic Executor.
"""
import uuid
import time
import logging
...
from .schemas import (
    ...
    CompareSchemesInput, CalculateBenefitQuantumInput,
    ScanPhishingScholarshipInput, LocateDistrictOfficeInput
)
from .tools.compare import execute_compare_schemes, CompareSchemesOutput
from .tools.quantum import execute_calculate_quantum, CalculateBenefitQuantumOutput
from .tools.phishing import execute_scan_phishing, ScanPhishingScholarshipOutput
from .tools.districts import execute_locate_district_office, LocateDistrictOfficeOutput

logger = logging.getLogger("civicproof.mcp.executor")
...
class MCPToolExecutor:
    ...
    @staticmethod
    def compare_schemes(params: CompareSchemesInput) -> CompareSchemesOutput:
        return execute_compare_schemes(params)

    @staticmethod
    def calculate_benefit_quantum(params: CalculateBenefitQuantumInput) -> CalculateBenefitQuantumOutput:
        return execute_calculate_quantum(params)

    @staticmethod
    def scan_phishing_scholarship(params: ScanPhishingScholarshipInput) -> ScanPhishingScholarshipOutput:
        return execute_scan_phishing(params)

    @staticmethod
    def locate_district_welfare_office(params: LocateDistrictOfficeInput) -> LocateDistrictOfficeOutput:
        return execute_locate_district_office(params)
